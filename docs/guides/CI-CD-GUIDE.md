...
3. **GitHub Release** - Release created with CHANGELOG notes for version tags
4. **Notify** - Deployment summary displayed
...
**Note:** npm publishing is currently manual. If you encounter errors during manual publishing:
