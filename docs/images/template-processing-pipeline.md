...
flowchart LR
    ...
    subgraph "Variable Registry"
        VARS["Variable Map<br/>PROJECT_NAME = my-app<br/>FRAMEWORK = Node.js<br/>PACKAGE_MANAGER = npm<br/>LINTING_TOOL = ESLint<br/>CI_PLATFORM = GitHub Actions<br/>CURRENT_DATE = 2025-12-28<br/>VERSION = 2.0.1"]
    end
