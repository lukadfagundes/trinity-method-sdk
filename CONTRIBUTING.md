...
Thank you for your interest in contributing to the Trinity Method SDK! This document
...
for all contributors. By participating, you agree to uphold this standard.
...
Major architectural decisions are documented in `docs/architecture/adr/`:
...
│   │   ├── commands/        # Command implementations (deploy/, update/)
│   │   ├── utils/           # Utility functions
│   │   └── types.ts         # Type definitions
│   ├── templates/           # Deployment templates (.claude/, root/, trinity/, linting/, ci/)
│   └── index.ts             # Main entry point
├── tests/                   # Test files
│   ├── unit/                # Unit tests
│   ├── integration/         # Integration tests
