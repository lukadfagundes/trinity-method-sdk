...
npm view trinity-method-sdk@2.0.6

# Install and test
npm install -g trinity-method-sdk@2.0.6
trinity --version
...
**Error:** Version mismatch - Tag: 2.0.6, package.json: 2.0.0

**Solution:**

```bash
# Update package.json version
npm version 2.0.6 --no-git-tag-version
