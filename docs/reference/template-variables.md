...
| `{{CURRENT_DATE}}`    | System date               | `2025-12-28`        | Trinity.md, VERSION       | ✅ Yes                |
| `{{VERSION}}`         | SDK package.json          | `2.0.0`             | Trinity.md, VERSION       | ✅ Yes                |
...
**Trinity Method SDK v2.0.0** - Template Variables Reference
