...
*This CLAUDE.md file provides testing standards for Trinity Method SDK. All tests must follow these conventions to ensure consistency and maintainability.*
