...
npm view trinity-method-sdk@2.0.7

# Install and test
npm install -g trinity-method-sdk@2.0.7
trinity --version
...
**Error:** Version mismatch - Tag: 2.0.7, package.json: 2.0.0
...
git commit -m "Bump version to 2.0.7"
