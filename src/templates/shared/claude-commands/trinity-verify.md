...
4. **Slash Commands (15 commands):**
   - .claude/commands/ (all Trinity slash commands)
   - Commands: init, verify, start, agents, requirements, design, plan, decompose,
               continue, end, workorder, create-investigation, plan-investigation,
               investigate-templates, orchestrate
